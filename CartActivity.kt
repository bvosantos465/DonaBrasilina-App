...
import com.example.byah_.donabrasilina.R.id.toolbar

class CartActivity : DebugActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar?.title = "Carrinho de Compras"
    ...
    private fun configuraMenuLateral() {
        var toolbar = findViewById<Toolbar>(toolbar)
        ...
        navigationView.setCheckedItem(R.id.mycart)
    }
