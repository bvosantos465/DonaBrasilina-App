...
class OrderActivity : DebugActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        order = intent.getSerializableExtra("pedido") as Order
        ...
        var texto = findViewById<TextView>(R.id.text_order)
        texto.text = order?.nome
        var imagem = findViewById<ImageView>(R.id.image_order)
        Picasso.with(this).load(order!!.image).fit().into(imagem,
    ...
    private fun configuraMenuLateral() {
        ...
        navigationView.setCheckedItem(R.id.myorders)
    }
