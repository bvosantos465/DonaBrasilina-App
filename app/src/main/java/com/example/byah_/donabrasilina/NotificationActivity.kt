...
class NotificationActivity : DebugActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar?.title = "Minhas Notificações"
    ...
    private fun configuraMenuLateral() {
        ...
        navigationView.setCheckedItem(R.id.mynotifications)
    }
